...
public class EmployeeTestComparater {
	...
	public static void main(String[] args) {
		...
		l.add(new Employee("b", 1, 1000));
		l.add(new Employee("b", 2, 3000));
		l.add(new Employee("a", 1, 5000));
		...
		//System.out.println("________________________");
		  ...
		  Iterator itt = l.iterator(); while (itt.hasNext()) {
		...
		//System.out.println("________________________");
		  ...
		  Collections.sort(l, byIdName); System.out.println("ShortByIdOrName>>>");
		  Iterator itl = l.iterator(); while (itl.hasNext()) {
		...
		//System.out.println("________________________");
		 ...
		 EmployeeShortByIdNameSalary byIdNameSalary = new
		 EmployeeShortByIdNameSalary(); Collections.sort(l, byIdNameSalary);
		 System.out.println("ShortByIdNameSalary>>>"); Iterator iti = l.iterator();
		 while (iti.hasNext()) { System.out.println(iti.next()); }
