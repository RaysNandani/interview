...
public class SteamStartWithT {
	...
	public static void main(String[] args) {
		...
		List<String> list = Arrays.asList("raj","naj", "kaj", "kapil", "Kapil","Kapil");

		list.stream().map(e -> e.toUpperCase()).filter(e -> e.startsWith("N")).distinct().sorted().forEach(System.out::println);
